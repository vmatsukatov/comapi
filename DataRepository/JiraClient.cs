...
namespace TechTalk.JiraRestClient
{
    ...
    internal class QueryableIssueCollection<TIssueFields> : IQueryable<Issue<TIssueFields>> where TIssueFields : IssueFields, new()
    {
        private JiraClient<TIssueFields> jiraClient;

        public QueryableIssueCollection(JiraClient<TIssueFields> jiraClient)
        {
